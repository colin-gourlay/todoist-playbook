...
- [GitHub Trending Repo Review](../github/github-trending-repo-review/)
...
2. `Create Todoist Project from Template` is triggered after a successful trending sync run and creates the **GitHub Trending Repo Review** project from `template.csv` in `github/github-trending-repo-review`.
