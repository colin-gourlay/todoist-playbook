...
2. Scan Trending Repositories
3. Evaluate Each Candidate Repo
4. Organise Your Stars as a Knowledge System
5. Reverse Engineer High-Signal Repos
6. Extract Insights and Convert to Actions
7. Track Star Velocity and Momentum
8. Close the Review
