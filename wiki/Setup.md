...
|----------|----------|-------------------|
| **Create Todoist Project from Template** | Fridays at 15:00 UTC, Sundays at 18:00 UTC | Creates `weekly-close` on Fridays and `weekly-plan` on Sundays; also runs after successful trending sync and creates `github-trending-repositories-daily-review` |
